$(function(){
           ...
           //check name  
			function check_name() {
				...
				}else if(name_length < 5 || name_length > 25) {

					$("#name_error_msg").html("name should be between 5-25 characters");
					$("#name_error_msg").show();
					error_name = true;
				} else {
					$("#name_error_msg").hide();
          ...
          //check address  
			...
			function check_role() {
			   ...
			   if (role_id.selectedIndex < 1) {
                    ...
                    $("#role_error_msg").html("select a account type");
					$("#role_error_msg").show();
					error_role = true;
          ...
          $("#registerformforbusiness").submit(function() {
											
				error_name = false;
				error_owner_name = false;
				error_email = false;
				error_phone = false;
				error_address = false;
				error_role = false;
				...
				if(error_name == false && error_owner_name == false && error_email == false && error_phone == false && error_address == false && error_role == false && error_password == false && error_confirm_password == false) {
					return true;
				} else {
					return false;	
				}
