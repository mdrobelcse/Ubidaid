...
class PaymentmethodController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('service_provider.payment_method.index',compact('payment_numbers'));
    }
    ...
    public function create()
    {
        ...
        return view('service_provider.payment_method.create',compact('payment_names'));
    }
    ...
    public function store(Request $request)
    {
       ...
       if ($check_duplicate_oayment_name->count() > 0 ) {
          ...
          return redirect()->back()->with('infoMsg','payment method already exist:)');
            ...
            //return redirect()->route('service_provider.paymentmethod.index');
           return redirect()->route('service_provider.paymentmethod.index')->with('successMsg','payment method successfully saved:)');
    ...
    public function edit($id)
    {
        ...
        return view('service_provider.payment_method.edit',compact('payment_names','payment_number'));
    }
    ...
    public function update(Request $request, $id)
    {
        $this->validate($request,[
            ...
            if($payment_number->payment_name == $duplicate_payment_name){
                    ...
                    //return redirect()->route('service_provider.paymentmethod.index');
                    return redirect()->route('service_provider.paymentmethod.index')->with('successMsg','payment method successfully updated:)');
            }else{
