            ...
            <div class="col-lg-8 col-xlg-9 col-md-7">
                <div class="card">
                    <div class="card-block">
                        <form action="{{ route('admin.category.update',$category->id) }}" method="post" class="form-horizontal form-material" enctype="multipart/form-data">
                            @csrf
                            @method('PUT')
                                ...
                                <div class="col-sm-12">
                                    <select name="typeofservice" class="form-control form-control-line">
                                        ...
                                        @foreach($servicetypes as $servicetype)
                                            ...
                                            <option {{ $category->servicetype_id == $servicetype->id ? 'selected' : '' }} value="{{ $servicetype->id }}">{{ $servicetype->name }}</option>
