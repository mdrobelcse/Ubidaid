            ...
            <div class="col-lg-8 col-xlg-9 col-md-7">
                <div class="card">
                    <div class="card-block">
                        <form action="{{ route('admin.blog.store') }}" method="post" class="form-horizontal form-material" enctype="multipart/form-data">
                        @csrf
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-12">
                                    <textarea name="description" class="form-control form-control-line" rows="10"></textarea>
                                </div>
                            </div>
