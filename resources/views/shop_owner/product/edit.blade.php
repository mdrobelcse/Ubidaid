            ...
            <div class="col-lg-8 col-xlg-9 col-md-7">
                <div class="card">
                    <div class="card-block">
                        <form action="{{ route('shop.product.update',$product->id) }}" method="post" class="form-horizontal form-material" enctype="multipart/form-data">
                            @csrf
                            @method('PUT')
                            <div class="form-group">
                                <label class="col-md-12">Product Name</label>
                                <div class="col-md-12">
                                    <input type="text" value="{{ $product->product_name }}" name="product_name" class="form-control form-control-line">
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-12">
                                    <input type="text" value="{{ $product->quantity }}" name="quantity" class="form-control form-control-line">
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-12">
                                    <textarea name="product_details" rows="5" class="form-control form-control-line">{{ $product->product_details }}</textarea>
                                </div>
                            </div>
