            ...
            <div class="col-lg-8 col-xlg-9 col-md-7">
                <div class="card">
                    <div class="card-block">
                        <form action="{{ route('shop.services.update',$service->id) }}" method="post" class="form-horizontal form-material" enctype="multipart/form-data">
                        @csrf
                        @method('PUT')
                            <div class="form-group">
                                <label class="col-md-12">Service Name</label>
                                <div class="col-md-12">
                                    <input type="text" name="service_name" class="form-control form-control-line" value="{{ $service->service_name }}">
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-12">
                                    <input type="text" name="price" class="form-control form-control-line" value="{{ $service->price }}">
                                </div>
                            </div>
                                ...
                                <div class="col-sm-12">
                                    <select name="subcategory" class="form-control form-control-line">
                                        ...
                                        @foreach($subcategories as $subcategory)
                                            <option {{ $subcategory->id == $service->subcategory_id ? 'selected':'' }} value="{{ $subcategory->id }}">{{ $subcategory->name }}</option>
                                        @endforeach
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-12">
                                    <textarea name="service_details" rows="5" class="form-control form-control-line">{{ $service->service_details }}</textarea>
                                </div>
                            </div>
