                           ...
                           <div class="col-sm-12">
                                ...
                                <div class="register-form">
                                  <h3>Shipping information</h3>
                                       <form name="mycheckoutform" id="customerorder" action="{{ route('user.order') }}" method="post" onsubmit="return validateForm();">
                                       @csrf
                                             <div class="form-group">
                                                 <input type="hidden" class="form-control" id="shop_id" name="shop_id" value="{{ $user->id }}">
                                            </div>
 ...
 <script src="{{ asset('public/js/checkout.js') }}"></script> 
   ...
   <script type="text/javascript">
      ...
      function validateForm(){
           ...
           var name          = document.mycheckoutform.name;
           var email         = document.mycheckoutform.email;
           var phone         = document.mycheckoutform.phone;
           var shipping_address         = document.mycheckoutform.shipping_address;
           var payment_method          = document.mycheckoutform.payment_method;
           var transanction_id          = document.mycheckoutform.transanction_id;
