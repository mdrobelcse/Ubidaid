            ...
            <div class="col-lg-8 col-xlg-9 col-md-7">
                <div class="card">
                    <div class="card-block">
                        <form action="{{ route('service_provider.service.update',$product->id) }}" method="post" class="form-horizontal form-material" enctype="multipart/form-data">
                        @csrf
                        @method('PUT')
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-12">
                                    <input type="text" name="price" class="form-control form-control-line" value="{{ $product->price }}">
                                </div>
                            </div>
