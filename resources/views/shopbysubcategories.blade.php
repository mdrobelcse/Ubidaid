	                            ...
	                            <div class="col-md-8 col-lg-8 col-sm-12 col-xs-12">
	                             ...
	                             <div class="col-md-4 col-lg-4 col-sm-12 col-xs-12">
	                                   <div class="search-right">
                                        ...
                                        @if($shop->user->profile == 'default.png') 

                                          <img class="img-responsive" src="{{ asset('public/uploads/shopbanner/default/default.jpg') }}" alt="">
                                        @else

                                          <img class="img-responsive" src="{{ asset('public/uploads/shopbanner/'.$shop->user->profile) }}" alt="">

                                        @endif


	                                          <div class="search-shop-details">
	                                                <h4>{{ $shop->user->name }} (ID:{{ $shop->user_id }})</h4>
	                                                <h5>Location: {{ $shop->user->address }}</h5>
	                                                <h5>Owner: {{ $shop->user->owner_name }}</h5>
	                                          </div>
	                                    </div>
	                             </div>
	                         </div>
